import { Controller, Param, Post, Body, UseGuards, UseInterceptors, UploadedFiles, Req } from "@nestjs/common";
...
export class CUsersController {
    ...
    @Post("tg-event")
    public onTgEvent(@Body() dto: ITgEvent, @Req() request: Request): Promise<void> {
