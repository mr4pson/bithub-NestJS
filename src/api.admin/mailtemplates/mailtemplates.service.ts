...
export class CMailtemplatesService {
  ...
  public async one(id: number): Promise<IResponse<CMailtemplate>> {
    try {
      ...
      return data
        ? { statusCode: 200, data }
        : { statusCode: 404, error: 'mailtemplate not found' };
    } catch (err) {
      const error = await this.errorsService.log(
        'api.admin/CMailtemplatesService.one',
        err,
      );
      return { statusCode: 500, error };
    }
  ...
  public async delete(id: number): Promise<IResponse<void>> {
    try {
      ...
      const error = await this.errorsService.log(
        'api.admin/CMailtemplatesService.delete',
        err,
      );
      return { statusCode: 500, error };
    }
  ...
  public async deleteBulk(ids: number[]): Promise<IResponse<void>> {
    try {
      ...
      const error = await this.errorsService.log(
        'api.admin/CMailtemplatesService.deleteBulk',
        err,
      );
      return { statusCode: 500, error };
    }
  ...
  public async create(fd: IJsonFormData): Promise<IResponse<CMailtemplate>> {
    try {
      ...
      const error = await this.errorsService.log(
        'api.admin/CMailtemplatesService.create',
        err,
      );
      return { statusCode: 500, error };
    }
  ...
  public async update(fd: IJsonFormData): Promise<IResponse<CMailtemplate>> {
    try {
      ...
      const error = await this.errorsService.log(
        'api.admin/CMailtemplatesService.update',
        err,
      );
      return { statusCode: 500, error };
    }
