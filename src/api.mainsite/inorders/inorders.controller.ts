...
export class CInordersController {
    ...
    @Post("create")
    public create(@Body() dto: IInorderCreate, @Req() request: Request): Promise<IResponse<string>> {
    ...
    @Post("complete")
    public complete(@Body() dto: IWpEvent, @Req() request: Request): Promise<string> {           
